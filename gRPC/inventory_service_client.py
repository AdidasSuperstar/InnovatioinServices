...
def generate_product_list():
    ...
    yield inventory_service_pb2.ProductType(type="Markus chair")
...
def run():
    ...
    channel = grpc.insecure_channel('34.90.19.212:5005')
    ...
    response2 = stub.GetProductQuantity(inventory_service_pb2.ProductType(type="Markus chair"))
    logging.info("Quantity for Product Type Markus chair : " + str(response2.amount))
    ...
    logging.info("Quantity for Product Type Markus chair : " + str(response.productStocks["Markus chair"].amount))
